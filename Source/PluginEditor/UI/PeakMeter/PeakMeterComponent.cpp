...
PeakMeterComponent::PeakMeterComponent(ProcessorProvider &pp, int index, bool usePeakHold)
...
void PeakMeterComponent::paint(juce::Graphics &g) {
  ...
  juce::DropShadow ds(juce::Colours::black.withAlpha(0.5f), 1, {0, 3});
...
void PeakMeterComponent::timerCallback() {
  ...
  peakHoldShownLevel = showPeakHold ? juce::jlimit(kMeterMinDb, kMeterMaxDb, peakHoldLevel) : kMeterMinDb;
