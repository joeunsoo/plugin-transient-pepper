...
KnobComponent::KnobComponent(EditorProvider &ep, const ScaleProvider &sp, ProcessorProvider &pp, const String &paramID,
  ...
  rotarySlider.setColour(juce::Slider::rotarySliderFillColourId, juce::Colours::orange);

  rotarySlider.setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colours::blue);
