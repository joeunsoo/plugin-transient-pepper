...
//==============================================================================
DeactivateComponent::DeactivateComponent(ActivateModal &modal, const ScaleProvider &sp, LicenseProvider &lp)
...
void DeactivateComponent::resized() {
  ...
  flexBox.items.add(FlexItem(deactivateButton).withWidth(80.0f * scale).withMinHeight(20.0f * scale));
