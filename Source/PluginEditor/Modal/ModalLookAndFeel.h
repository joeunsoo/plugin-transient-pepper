...
struct ModalLookAndFeel : public LookAndFeel_V4
{
  public:
    ...
    void drawTextEditorOutline(juce::Graphics &g, int width, int height, juce::TextEditor &textEditor) override
    {
        ...
        g.setColour(textEditor.hasKeyboardFocus(true) ? textEditor.findColour(juce::TextEditor::focusedOutlineColourId)
                                                      : textEditor.findColour(juce::TextEditor::outlineColourId));

        g.drawRoundedRectangle(bounds.reduced(borderThickness * 0.5f), cornerSize, borderThickness);
    }
