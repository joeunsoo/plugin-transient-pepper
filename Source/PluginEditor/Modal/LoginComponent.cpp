...
//==============================================================================
LoginComponent::LoginComponent(ActivateModal &modal, const ScaleProvider &sp, LicenseProvider &lp)
    : modalRef(modal), scaleProvider(sp), licenseProvider(lp), trialComponent(modal, lp) {
...
void LoginComponent::resized() {
  ...
  flexBox.items.add(FlexItem(trialComponent).withWidth(bounds.getWidth()).withMinHeight(20.0f * scale));
