...
{
  public:
    MenuLookAndFeel(const ScaleProvider &sp) : scaleProvider(sp) {}
    ...
    juce::Font getPopupMenuFont() override { return juce::Font{mainFont}; }

    void setWindowScale(int value) { windowScale = value; }
                                   ...
                                   int &idealHeight) override
    {
        ...
        else
        {
            ...
            idealHeight =
                standardMenuItemHeight > 0 ? standardMenuItemHeight : roundToInt(font.getHeight() * heightScale);
                           ...
                           const Colour *const textColourToUse) override
    {
        ...
        {
            auto textColour = (textColourToUse == nullptr ? getTextColour() : *textColourToUse);
            ...
            if ((text == "100%" && windowScale == 100) || (text == "150%" && windowScale == 150) ||
